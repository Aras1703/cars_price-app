...
def app():
    ...
    if prediksi:
        result = predict_price(location, year, km_driven, fuel_type, transmission, owner_type, seats,
        ...
        with col21:
            st.markdown('<p style="color:red;font-weight:600">All Data must be input ! </p>', unsafe_allow_html=True)